...
CREATE TABLE `Monster` (
  ...
  CONSTRAINT `fk_monster_habitat` FOREIGN KEY (`Habitat_ID`) REFERENCES `Habitat` (`Habitat_ID`),
  CONSTRAINT `fk_monster_species` FOREIGN KEY (`Species_ID`) REFERENCES `Species` (`Species_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `Monster_Dmg_Element` (
  ...
  CONSTRAINT `fk_mon_dmg_element` FOREIGN KEY (`Element_ID`) REFERENCES `Element` (`Element_ID`),
  CONSTRAINT `fk_mon_dmg_monster` FOREIGN KEY (`Monster_ID`) REFERENCES `Monster` (`Monster_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `Monster_Weakness` (
  ...
  KEY `Monster_ID` (`Monster_ID`),
  KEY `Element_ID` (`Element_ID`),
  CONSTRAINT `fk_mon_weak_element` FOREIGN KEY (`Element_ID`) REFERENCES `Element` (`Element_ID`),
  CONSTRAINT `fk_mon_weak_monster` FOREIGN KEY (`Monster_ID`) REFERENCES `Monster` (`Monster_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `Hunters` (
  ...
  `palico_name` varchar(100) DEFAULT 'Palico',
...
CREATE TABLE `Weapon` (
  ...
  KEY `Element_ID` (`Element_ID`),
  KEY `Monster_ID` (`Monster_ID`),
  CONSTRAINT `fk_weapon_element` FOREIGN KEY (`Element_ID`) REFERENCES `Element` (`Element_ID`),
  CONSTRAINT `fk_weapon_monster` FOREIGN KEY (`Monster_ID`) REFERENCES `Monster` (`Monster_ID`),
  CONSTRAINT `fk_weapon_type` FOREIGN KEY (`Weapon_Type_ID`) REFERENCES `Weapon_Type` (`Weapon_Type_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `Weapon_Crafting` (
  ...
  KEY `Item_ID` (`Item_ID`),
  CONSTRAINT `fk_craft_item` FOREIGN KEY (`Item_ID`) REFERENCES `Item` (`Item_ID`),
  CONSTRAINT `fk_craft_weapon` FOREIGN KEY (`Weapon_ID`) REFERENCES `Weapon` (`Weapon_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
